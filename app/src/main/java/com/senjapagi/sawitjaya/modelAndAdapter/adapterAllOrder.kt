...
class adapterAllOrder (private val orderData:MutableList<modelReqOrder>, val context:Context) :
    RecyclerView.Adapter<AllOrderHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllOrderHolder {
        return AllOrderHolder(LayoutInflater.from(context).inflate(R.layout.list_order,parent,false))
    }
    ...
    override fun onBindViewHolder(holder: AllOrderHolder, position: Int) {
        ...
        holder.btnOrderDetail.setOnClickListener {
            val e = Intent(context, UserOrderDetail::class.java)
...
class AllOrderHolder(view: View) : RecyclerView.ViewHolder(view) {
    val id = view.orderID
