...
import kotlinx.android.synthetic.main.fragment_user_all_transaction.*
 ...
 * Use the [fragment_user_all_transaction.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragment_user_all_transaction : Fragment() {
    ...
    fun NavDrawToggle(indicator: String) {
        if (indicator.equals("open")) {
            ...
            lyt_user_transaction.background.alpha = 200
        } else {
            lyt_navdraw.animation =
                AnimationUtils.loadAnimation(context, R.anim.fade_transition_animation_go)
            lyt_navdraw.visibility = View.GONE
            lyt_user_transaction.background.alpha = 255
        }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_user_all_transaction, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment fragment_user_all_transaction.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            fragment_user_all_transaction().apply {
