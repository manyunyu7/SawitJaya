 ...
 * Use the [finishedOrderFragment.newInstance] factory method to
...
class finishedOrderFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_finished_order, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        recyclerViewFinishedOrder?.visibility = View.VISIBLE
        recyclerViewFinishedOrder.setHasFixedSize(true)
        recyclerViewFinishedOrder.layoutManager = LinearLayoutManager(
            context, RecyclerView.VERTICAL,false)

        srlOrderFinished.setOnRefreshListener {
            srlOrderFinished.isRefreshing=false
            getOrder()
        }
    }
            ...
            AndroidNetworking.get(api.USER_ORDER_SUCCESS)
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    override fun onResponse(response: JSONObject) {
                        ...
                        if(raz.length()<1){
                            finishedErrorPlaceHolder.visibility=View.VISIBLE
                            finishedErrorPlaceHolder.text="Anda Belum Memiliki Order Selesai"
                        }
                        if (response.getBoolean("success_status")) {
                            ...
                            recyclerViewFinishedOrder?.adapter = adapterOrder
                            recyclerViewFinishedOrder?.visibility = View.VISIBLE
                        } else {
                            finishedErrorPlaceHolder.text = "Terjadi Error yang tidak diketahui"
                        }
                    }

                    override fun onError(anError: ANError?) {
                        anim_loading.visibility=View.GONE
                        finishedErrorPlaceHolder.text = "Gagal Terhubung Dengan Server \n ${anError.toString()}"
                    }
    ...
    companion object {
         ...
         * @return A new instance of fragment finishedOrderFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            finishedOrderFragment().apply {
