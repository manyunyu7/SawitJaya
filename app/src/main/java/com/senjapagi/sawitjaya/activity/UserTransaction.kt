...
import com.senjapagi.sawitjaya.UserOrderPagerAdapter
import kotlinx.android.synthetic.main.activity_user_all_transaction.*

class UserTransaction : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragmentAdapter = UserOrderPagerAdapter(supportFragmentManager)
